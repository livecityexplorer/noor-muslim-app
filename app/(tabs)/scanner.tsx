      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.quickActionsGrid}>
            ...
            >
              <LinearGradient colors={["#166534", "#14532D"]} style={styles.quickActionLarge}>
                <Text style={styles.quickActionEmoji}>📱</Text>
                <Text style={styles.quickActionTitle}>Scan Barcode</Text>
                <Text style={styles.quickActionSub}>Point camera at product</Text>
              </LinearGradient>
            </Pressable>
            ...
            >
              <LinearGradient colors={["#1E3A5F", "#1E3A8A"]} style={styles.quickActionLarge}>
                <Text style={styles.quickActionEmoji}>🔍</Text>
                <Text style={styles.quickActionTitle}>Search Products</Text>
                <Text style={styles.quickActionSub}>Search by name or barcode</Text>
              </LinearGradient>
            </Pressable>
            ...
            >
              <LinearGradient colors={["#713F12", "#92400E"]} style={styles.quickActionSmall}>
                <Text style={styles.quickActionEmoji}>📖</Text>
                <Text style={styles.quickActionTitle}>Ingredient Guide</Text>
              </LinearGradient>
            </Pressable>
            ...
            >
              <LinearGradient colors={["#4A1D96", "#5B21B6"]} style={styles.quickActionSmall}>
                <Text style={styles.quickActionEmoji}>📚</Text>
...
const styles = StyleSheet.create({
  ...
  quickActionLarge: { width: "48%", borderRadius: 16, padding: 18, minHeight: 110, justifyContent: "flex-end" },
  quickActionSmall: { width: "48%", borderRadius: 16, padding: 16, minHeight: 90, justifyContent: "flex-end" },
  quickActionEmoji: { fontSize: 28, marginBottom: 8 },
  quickActionTitle: { fontSize: 15, fontWeight: "700", color: "#FFFFFF" },
  quickActionSub: { fontSize: 11, color: "rgba(255,255,255,0.7)", marginTop: 2 },
  insightCard: { borderRadius: 14, padding: 16 },
  ...
  ingredientOfDay: { backgroundColor: "#111827", borderRadius: 14, padding: 16, flexDirection: "row", gap: 12 },
  ...
  recentCard: { width: 120, backgroundColor: "#111827", borderRadius: 12, padding: 10, marginRight: 10, alignItems: "center" },
  ...
  statCard: { flex: 1, backgroundColor: "#111827", borderRadius: 12, padding: 14, alignItems: "center" },
